...
var astToStr = function(ast, indentLevel, indentChar) {
...
var DotGraph = (function() {

  /**
   *Création d'un id ramdom.
   */
  var giveRandomKey = function() {
    return Math.random().toFixed(8).slice(2);
  };

  /**
   * recopie les données de l'obj2 dans l'objet 1 si absente.
   */
  var mergeLeftNoOverried = function(obj1, obj2) {
    var k, v;
    for (k in obj2) {
      v = obj2[k];
      if (!(obj1[k] != null)) {
  ...
  /**
   * recopie l'obj2 dans l'objet 1 sans se poser de question.
   */
  var mergeLeftOverried = function(obj1, obj2) {
    var k, v;
    for (k in obj2) {
      v = obj2[k];
      obj1[k] = v;
  ...
  /**
   * clone une structure object sur 1 niveau
   */
  ...
  /**
  clone une structure object sur 2 niveau
  */
  var doubleCopy = function(obj) {
    var k, ret, v;
    ret = {};
    for (k in obj) {
      v = obj[k];
   ...
   *
   */
  var attrListToObj = function(list) {
  ...
  */
  ...
  DotGraph.prototype.walk = function(ast) {
    ...
    /**
     * fonction qui parcours l'arbreAST.
     * @param {Object } tre - l'arbre AST.
     */
  ...
  DotGraph.prototype.generateAst = function() {
    ...
    /**
     * Genere un edge.
     * @param {Array|Object} edge - un edge.
     * @returns {Object} une structure du type edgeAST.
     */
    ...
    /**
     * Genere un SubgraphAst.
     * @param {id} graph .
     * @returns {Object} une structure du type SubgraphAst.
     */
